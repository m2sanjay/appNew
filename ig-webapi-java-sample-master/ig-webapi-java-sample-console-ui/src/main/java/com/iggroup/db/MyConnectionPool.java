...
public class MyConnectionPool {
	 ...
	 */
	private static MyConnectionPool _constructor = null;
	public synchronized static MyConnectionPool getInstance() 
	{
		if(_constructor == null) {
			_constructor = new MyConnectionPool(
				"jdbc:mysql://igindexdb1.cmkpuqujviqt.eu-west-2.rds.amazonaws.com:3306/igindexdb1",
				"igindexdb", "igindexdb", 2);
			return _constructor;
		}else {
			return _constructor;
		}
	...
	private MyConnectionPool(String databaseUrl, String userName,
