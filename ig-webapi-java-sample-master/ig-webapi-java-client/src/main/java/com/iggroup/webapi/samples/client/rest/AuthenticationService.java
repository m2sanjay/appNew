...
public class AuthenticationService extends AbstractService {
   ...
   public AuthenticationResponseAndConversationContext createSessionV3(CreateSessionV3Request authenticationRequest, String apiKey) {
	   System.out.println(new Date()+" | "+Thread.currentThread().getName() + " | " + " Going to Authenticate");
	   final ResponseEntity<CreateSessionV3Response> responseEntity = authenticateV3(authenticationRequest, apiKey);
	   System.out.println(new Date()+" | "+Thread.currentThread().getName() + " | " + " Authenticated Successfully");
   ...
   protected ResponseEntity<CreateSessionV3Response> authenticateV3(CreateSessionV3Request request, String apiKey) {
      ...
      System.out.println(new Date()+" | "+Thread.currentThread().getName() + " | " + " In authenticateV3");
      ResponseEntity<CreateSessionV3Response> res = restTemplate.exchange(getIGApiDomainURL() + "/" + addIGApiLightDarkCluster(uri), HttpMethod.POST, requestEntity, CreateSessionV3Response.class);
      System.out.println(new Date()+" | "+Thread.currentThread().getName() + " | " + " Out authenticateV3 "+res);
      return res;
   }
