...
public String getDetails() {
	...
	sb.append("Currency: ".concat(getCurrency()));
	sb.append(" DealId: ".concat(getDealId()));
	sb.append(" DealRef: ".concat(getDealReference()));
	sb.append(" ContractSize: ".concat(getContractSize().toString()));
	sb.append(" Direction: ".concat(getDirection().name()));
	sb.append(" CreatedDt: ".concat(getCreatedDate()));
	sb.append(" DealId: ".concat(getDealId()));
	return sb.toString();
}
}
